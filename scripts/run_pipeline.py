...
if __name__ == "__main__":
    ...
    # Backfills
    ap.add_argument("--ingest-backfill-days", type=int, default=120)
    ap.add_argument("--feature-backfill-days", type=int, default=120)
    # ---- NEW: hard cap for incremental updates ----
    ap.add_argument("--max-update-days", type=int, default=120,
